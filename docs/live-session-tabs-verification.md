...
| --- | --- | --- |
| Active tab, folder baseline, workspace grouping, cross-row selection | `live_tabs_switch_rows_and_keep_the_folder_baseline` | Active tab is 4px taller, tab bottoms align with the body, both workspace labels exist, clicking another row selects that row and removes the stale focus marker |
