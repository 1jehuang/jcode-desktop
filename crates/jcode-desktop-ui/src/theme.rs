...
impl Theme {
    ...
    fn defaults() -> Self {
        Self {
            ...
            LINK: rgb_c(0xb4c8ff),
            MINIMAP_TRACK: rgba_c(0xffffff06),
            MINIMAP_TRACK_ACTIVE: rgba_c(0xffffff0d),
            MINIMAP_VIEWPORT: rgba_c(0x8ab4f880),
            MINIMAP_PANEL: rgb_c(0x45484e),
            MINIMAP_PANEL_BUSY: rgb_c(0x636a76),
