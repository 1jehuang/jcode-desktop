...
def main():
    ...
    parser.add_argument("--transcript", choices=("all", "empty", "reasoning", "streaming", "tool-streaming", "tool-icons", "prompts", "html", "image", "mermaid", "tokens", "diff", "diff-rich", "todos"), default="all",
